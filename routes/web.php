...
Route::get('/claims/{claim}/edit', 'ClientClaimController@edit')->middleware('role:management');
Route::post('/claims/{claim}','ClientClaimController@update')->middleware('role:management');
